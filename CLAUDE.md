...
| 2026-04-18 | Qwen3 pair sweep (8B target, 1.7B draft). Reasoning tokens emerge as their own distribution: MBPP reasoning has 10–11% below 0.9 acceptance (vs 3.8% for Qwen2.5 response); K=4 speedup drops 4.90× → 4.72×. Tail concentrates on common English discourse words inside `<think>` blocks. See `docs/research/2026-04-18-qwen3-reasoning-sweep.md`. |
